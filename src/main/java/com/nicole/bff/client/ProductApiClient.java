 ...
 */
@Getter
@Component("productApiClient")
@Slf4j
public class ProductApiClient implements ApiClientService{
    ...
    public void init() {
        ...
        this.productRestTemplate = new RestTemplate();
        productRestTemplate.setRequestFactory(factory);

        log.info("ProductApiClient 설정: connectionTimeout={}ms, responseTimeout={}ms",
    ...
    public void updateRestTemplate(TimeoutConfigDto timeoutConfigDto) {
        ...
        // 기존 productRestTemplate에 newRestTemplate 대입
        this.productRestTemplate = newRestTemplate;

        log.info("ProductApiClient 타임아웃 설정 변경됨: connectionTimeout={}ms, responseTimeout={}ms",
                connectTimeout, responseTimeout);
    }
}
